...
echo "=========================================="
echo "Step 14: Create Channel (Complete Policies)"
echo "=========================================="
...
# Create complete configtx.yaml
echo ""
echo "Creating configtx.yaml with complete policies..."
cat > configtx.yaml << 'EOF'
Organizations:
  - &Org1
    Name: m-KTGJMTI7HFGTZKU7ECMPS4FQUU
    ID: m-KTGJMTI7HFGTZKU7ECMPS4FQUU
    MSPDir: /opt/home/admin-msp
    Policies:
      Readers:
        Type: Signature
        Rule: "OR('m-KTGJMTI7HFGTZKU7ECMPS4FQUU.member')"
      Writers:
        Type: Signature
        Rule: "OR('m-KTGJMTI7HFGTZKU7ECMPS4FQUU.member')"
      Admins:
        Type: Signature
        Rule: "OR('m-KTGJMTI7HFGTZKU7ECMPS4FQUU.admin')"
      Endorsement:
        Type: Signature
        Rule: "OR('m-KTGJMTI7HFGTZKU7ECMPS4FQUU.member')"
